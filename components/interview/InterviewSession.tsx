        ...
        try {
            ...
            const sessionPromise = ai.live.connect({
                ...
                config: {
                    ...
                    systemInstruction: `You are Julia, a Visa Interview Assistant for visa interview preparation. You are helping a user prepare for their visa interview. get the user's name: ${userData.fullName}, country: ${userData?.country} , destination: ${destination}, visa type: ${visaType}, Introduce yourself and welcome the user by their first name. then ask user how many questions they want you to generate for the interview.  if the user is not clear, ask for clarification. Do not ask questions continuously, only ask one question at a time.`,
            ...
            setError(err.message || "Could not access microphone or connect to Gemini.");
